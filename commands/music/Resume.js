...
class Resume extends Command {
  ...
  async run (event, args) {
    ...
    if (!selfVoiceChannel || !selfVoiceChannel.channel_id) {
      ...
      this.client.shard.sendWS(event.gateway, 'W_VOICE_STATE_UPDATE', { shard_id: event.shard_id, guild_id: event.guild_id, channel_id: userVoiceChannel.channel_id, self_mute: false, self_deaf: false })
    }
